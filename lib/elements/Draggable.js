...
class Draggable extends React.Component {
  ...
  static propTypes = {
    ...
    // sticky x and y positions if you don't want the joystick to default to center
    stickyX: PropTypes.number,
    stickyY: PropTypes.number,
    // due to a bug when packaging for production, removed the prop validation
      ...
      PanResponder.create({
        ...
        onPanResponderEnd: (evt, gesture) => {
          ...
          if (this.props.sticky) {
            Animated.spring(
              this.state.pan,
              { toValue: { x: this.props.stickyX, y: this.props.stickyY } }
            ).start();
          } else {
